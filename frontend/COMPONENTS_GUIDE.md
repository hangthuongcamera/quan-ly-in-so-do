...
-   **File:** `frontend/components/DataTable.js`
...
-   **File:** `frontend/components/ModalService.js`
...
-   **File:** `frontend/components/ConfirmDialog.js`
...
-   **File:** `frontend/components/Form.js`
